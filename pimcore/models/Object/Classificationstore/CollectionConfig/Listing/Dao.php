...
class Dao extends Model\Listing\Dao\AbstractDao
{
    ...
    {
        try {
            $amount = (int) $this->db->fetchOne("SELECT COUNT(*) as amount FROM " . Object\Classificationstore\CollectionConfig\Dao::TABLE_NAME_COLLECTIONS . " ". $this->getCondition(), $this->model->getConditionVariables());
        } catch (\Exception $e) {
        }
